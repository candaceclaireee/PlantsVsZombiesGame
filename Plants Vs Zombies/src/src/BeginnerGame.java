...
import java.util.*;
/**
 * BeginnerGame is a subclass of State and handles the updating and rendering of all entities, timers to generate zombies 
 * and suns and changing delay based on the current number of seconds.
 * 
 * @author Dequito, Christian and Mercado, Candace 
 * @since 2017-07-28
 */
public class BeginnerGame extends State 
{
    private Garden gard;
    ...
    /**
     * Constructor for BeginnerGame. This initializes the world (beginner level) and starts the game timer, timer for 
     * generating zombies and generating sun.
     */
    public BeginnerGame()
    {           
        gard = new Garden("src/res/garden/gardenB.txt");
        
        gameTimer.scheduleAtFixedRate(task1, 0000, 1000); 
	gameTimer.scheduleAtFixedRate(task2, 30000, delay); // GENERATES A ZOMBIES AT INTERVALS/ STARTS AFTER 30S
	gameTimer.scheduleAtFixedRate(task3, 0000, 7000); // GENERATES A SUNS AT EVERY 7
    }
     /**
